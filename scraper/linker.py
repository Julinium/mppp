...
def page2Links(driver, page_number, pages):
    ...
    helper.printMessage('INFO', 'linker.page2Links', f'### Getting links from page {page_number:03}/{pages:03}:\n')
    links = []
    try:
        i = 1
        ...
        while details_btn != None:
            ...
            helper.printMessage('DEBUG', 'linker.page2Links', f'### Getting link {i:03} from page {page_number:03} for id={portal_id_text}')
        ...
        helper.printMessage('FATAL', 'linker.page2Links', f'Exception while getting links from page {page_number:03}')
        traceback.print_exc()
